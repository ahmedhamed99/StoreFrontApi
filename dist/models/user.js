...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("could not get user ".concat(id, " :").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, hash, result, createdUser, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [user.firstName, user.lastName, user.username, hash])];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("could not create user ".concat(user.firstName, " ").concat(user.lastName, " :").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("could not authenticate user ".concat(username, ": ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
