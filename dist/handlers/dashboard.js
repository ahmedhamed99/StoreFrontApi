...
var verify_auth_token_1 = __importDefault(require("../services/auth/verify_auth_token"));
...
var currentOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, orders, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userId = req.params.id;
                return [4 /*yield*/, dashboard.currentOrdersByUser(userId)];
            case 1:
                orders = _a.sent();
                console.log(orders);
                res.json(orders);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userId = req.params.id;
                return [4 /*yield*/, dashboard.completedOrdersByUser(userId)];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 3];
...
var productsByCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var category, products, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                category = req.params.category;
                return [4 /*yield*/, dashboard.productByCategory(category)];
            case 1:
                products = _a.sent();
                res.json(products);
                return [3 /*break*/, 3];
...
var mostPopularProducts = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, dashboard.mostPopularProducts()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [3 /*break*/, 3];
...
var dashboardRoutes = function (app) {
    app.get('/users/:id/current-orders', verify_auth_token_1["default"], currentOrders);
    app.get('/users/:id/completed-orders', verify_auth_token_1["default"], completedOrders);
